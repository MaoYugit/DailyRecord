---
name: figma
description: '通过 Figma MCP 获取设计上下文、截图、变量和资源。'
---
...
## References
- `references/figma-mcp-config.md` 鈥?setup, verification, troubleshooting, and link-based usage reminders.
- `references/figma-tools-and-prompts.md` 鈥?tool catalog and prompt patterns for selecting frameworks/components and fetching metadata.
